    ...
    <div>
        <div class="card_head" @mouseenter="show(item)" @mouseleave="show(item)" v-for="item in msg" :key="item.title">
            ...
            <swiper :options="swiperOption">
                <swiper-slide v-for="(slide,index) in item.swiperSlides" :key="index"><img
                        :src="slide.src"  @click="gotoDetail(slide.id)" /><a>123</a></swiper-slide>
...
<script>
    ...
    import text4 from "../assets/text4.jpg"
    import text5 from "../assets/text5.jpg"
    import text6 from "../assets/text6.jpg"
    import text7 from "../assets/text7.jpg"
    import text8 from "../assets/text8.jpg"
    import text9 from "../assets/text9.jpg"
    import text10 from "../assets/text10.jpg"
...
<style>
    ...
    .swiper-button-next {
        background-image: url("../assets/right-circle.png");
